...
export default function Search() {
    ...
    useEffect(() => {
        ...
        const fetchListings = async () => {
            setLoading(true);
            setShowMore(false);
            const searchQry = urlParams.toString();
            try {
                const response = await fetch(`/api/listing/get?${searchQry}`);
            ...
            <div className="p-7 border-b-2 md:border-r-2 md:min-h-screen">
                <form onSubmit={handleSubmit} className='flex flex-col gap-8'>
                    <div className="flex items-center gap-2">
                        ...
                        <input type="text" name="" id="searchTerm" placeholder='Seach...' 
                    ...
                    <button type='submit' className='bg-slate-500 text-white p-3 rounded-lg uppercase hover:opacity-95'>Search</button>
